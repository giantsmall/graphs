...
//			_plotBounds = null;
        ...
        public List<LineSegment> DelaunayTriangulation(List<PtWSgmnts> points)
        {
        ...
        public List<LineSegment> SpanningTree(List<PtWSgmnts> points, KruskalType type = KruskalType.MINIMUM/*, BitmapData keepOutMask = null*/)
        {
            List<Edge> edges = DelaunayHelpers.SelectNonIntersectingEdges(/*keepOutMask,*/_edges);
            List<LineSegment> segments = DelaunayHelpers.DelaunayLinesForEdges(edges, points);
            return DelaunayHelpers.Kruskal(segments, type);
        }
